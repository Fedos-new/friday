...
export const setMinMaxCardsCountAC = (minCardsCount: number, maxCardsCount: number) => ({type: SET_MIN_COUNT_MAX_COUNT, minCardsCount, maxCardsCount} as const)
